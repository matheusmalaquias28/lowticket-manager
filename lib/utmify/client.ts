...
function mapToPayload(d: any, date: string): UtmifyStorePayload {
  ...
  return {
    ...
    cpa_cents:             d.analytics?.cpa != null ? Math.round(d.analytics.cpa) : undefined,
    avg_ticket_cents:      d.analytics?.avgTicket != null ? Math.round(d.analytics.avgTicket) : undefined,
